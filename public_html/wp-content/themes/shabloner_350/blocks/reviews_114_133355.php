...
<div id="" class="">
	...
	<div class="testimonial  bottommargin-sm">
		<div class="testi-image">
			<a href="#"><img src="<?=get_template_directory_uri()?>/files/ct_block_item_133355_2_2_image.jpeg"></a>
		</div>
	...
	<div class="testimonial  bottommargin-sm">
		<div class="testi-image">
			<a href="#"><img src="<?=get_template_directory_uri()?>/files/ct_block_item_133355_1_2_image.png"></a>
		</div>
		<div class="testi-content">
	...
	<div class="testimonial  bottommargin-sm">
		<div class="testi-image">
			<a href="#"><img src="<?=get_template_directory_uri()?>/files/ct_block_item_133355_3_2_image.jpg"></a>
		</div>
		<div class="testi-content">
