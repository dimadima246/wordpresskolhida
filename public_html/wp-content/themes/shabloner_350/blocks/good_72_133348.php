...
<h2 class="notransform t600 mb-2 editable block_133348 item-option_185008 field_title" style="">Юридическим лицам Все услуги</h2>
	...
	<div class="col_one_fourth  nobottommargin">
		<div class="feature-box center media-box fbox-bg">
			<div class="fbox-media">
				<a href="/arbitrazhnye-spory"><img class="image_fade" src="<?=get_template_directory_uri()?>/files/ct_block_item_133348_128042_5_image.jpg"></a>
			</div>
			<div class="fbox-desc">
	...
	<div class="col_one_fourth  nobottommargin">
		<div class="feature-box center media-box fbox-bg">
			<div class="fbox-media">
				<a href="/iuridicheskoe-soprovozhdenie-tszh-zhsk-uk"><img class="image_fade" src="<?=get_template_directory_uri()?>/files/ct_block_item_133348_1_5_image.jpg"></a>
			</div>
			<div class="fbox-desc">
	...
	<div class="col_one_fourth  nobottommargin">
		<div class="feature-box center media-box fbox-bg">
			<div class="fbox-media">
				<a href="/iuridicheskoe-soprovozhdenie-organizacii"><img class="image_fade" src="<?=get_template_directory_uri()?>/files/ct_block_item_133348_2_5_image.jpg"></a>
			</div>
			<div class="fbox-desc">
	...
	<div class="col_one_fourth col_last nobottommargin">
		<div class="feature-box center media-box fbox-bg">
			<div class="fbox-media">
				<a href="/zashita-intellektualnoi-sobstvennosti"><img class="image_fade" src="<?=get_template_directory_uri()?>/files/ct_block_item_133348_3_5_image.jpg"></a>
			</div>
			<div class="fbox-desc">
	...
	<div class="col_one_fourth  nobottommargin">
		<div class="feature-box center media-box fbox-bg">
			<div class="fbox-media">
				<a href="/nedvizhimost-zemlia"><img class="image_fade" src="<?=get_template_directory_uri()?>/files/ct_block_item_133348_4_5_image.jpg"></a>
			</div>
			<div class="fbox-desc">
	...
	<div class="col_one_fourth  nobottommargin">
		<div class="feature-box center media-box fbox-bg">
			<div class="fbox-media">
				<a href="/zashita-delovoi-reputacii"><img class="image_fade" src="<?=get_template_directory_uri()?>/files/ct_block_item_133348_5_5_image.jpg"></a>
			</div>
			<div class="fbox-desc">
	...
	<div class="col_one_fourth  nobottommargin">
		<div class="feature-box center media-box fbox-bg">
			<div class="fbox-media">
				<a href="/dosudebnoe-uregulirovanie"><img class="image_fade" src="<?=get_template_directory_uri()?>/files/ct_block_item_133348_6_5_image.jpg"></a>
			</div>
			<div class="fbox-desc">
	...
	<div class="col_one_fourth col_last nobottommargin">
		<div class="feature-box center media-box fbox-bg">
			<div class="fbox-media">
				<a href="/ispolnitelnoe-proizvodstvo"><img class="image_fade" src="<?=get_template_directory_uri()?>/files/ct_block_item_133348_7_5_image.jpg"></a>
			</div>
			<div class="fbox-desc">
