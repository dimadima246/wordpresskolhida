	...
	<div class="slider-parallax-inner">
		...
		<div class="swiper-container swiper-parent">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide dark" style="background-image: url('<?=get_template_directory_uri()?>/files/ct_block_item_133337_628721_6_image.jpg');">
				...
				<div class="swiper-slide dark" style="background-image: url('<?=get_template_directory_uri()?>/files/ct_block_item_133337_1_6_image.jpg');">
				    <div class="overfill" style="background-color: rgba(0, 0, 0, 0.40);"></div>
					<div class="container clearfix">
						<div class="slider-caption slider-caption-center">
				...
				<div class="swiper-slide dark" style="background-image: url('<?=get_template_directory_uri()?>/files/ct_block_item_133337_2_6_image.jpg');">
				    <div class="overfill" style="background-color: rgba(0, 0, 0, 0.40);"></div>
					<div class="container clearfix">
						<div class="slider-caption slider-caption-center">
